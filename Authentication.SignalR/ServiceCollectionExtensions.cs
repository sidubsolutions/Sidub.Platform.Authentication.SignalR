...
namespace Sidub.Platform.Authentication
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds Sidub authentication for SignalR.
        /// </summary>
        /// <param name="services">The <see cref="IServiceCollection"/> to add the authentication services to.</param>
        /// <returns>The modified <see cref="IServiceCollection"/>.</returns>
        public static IServiceCollection AddSidubAuthenticationForSignalR(
            this IServiceCollection services)
        {
            services.TryAddTransient<IAuthenticationHandler, HubConnectionBuilderAuthenticationHandler>();
